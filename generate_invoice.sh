...
# Pasta de saída
INVOICE_DIR="${TEMPLATE_DIR}/invoices"
mkdir -p "$INVOICE_DIR"
...
# Substituindo variáveis do template
...
mv "${TEMPLATE_DIR}/invoice_temp.pdf" "${INVOICE_DIR}/${PDFNAME}"
...
if [ -f "${INVOICE_DIR}/${PDFNAME}" ]; then
    echo "PDF gerado com sucesso em: ${INVOICE_DIR}/${PDFNAME}"
else
